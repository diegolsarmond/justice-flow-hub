-- Migração Supabase: orquestração/agendamento da Edge Function sync-intimacoes-oab
-- Objetivo:
...
-- Reforço de idempotência em intimacoes (evita duplicação por origem externa).
...
-- Reconfigure depois com public.configurar_agendamento_sync_intimacoes('*/15 * * * *', ...)
select public.configurar_agendamento_sync_intimacoes('*/30 * * * *');
