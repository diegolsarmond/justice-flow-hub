...
CREATE TABLE IF NOT EXISTS public.area_atuacao ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, CONSTRAINT area_atuacao_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.asaas_customers ( cliente_id int8 NOT NULL, integration_api_key_id int8 NOT NULL, asaas_customer_id text NULL, status text DEFAULT 'pending'::text NOT NULL, synced_at timestamptz NULL, last_payload jsonb NULL, CONSTRAINT asaas_customers_pkey PRIMARY KEY (cliente_id, integration_api_key_id));
...
CREATE TABLE IF NOT EXISTS public.blog_posts ( id uuid NOT NULL, title text NOT NULL, description text NOT NULL, "content" text NULL, author text NOT NULL, published_at timestamptz NOT NULL, read_time text NOT NULL, category int4 NOT NULL, image text NULL, slug text NOT NULL, tags _text DEFAULT '{}'::text[] NOT NULL, featured bool DEFAULT false NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT blog_posts_pkey PRIMARY KEY (id), CONSTRAINT blog_posts_slug_key UNIQUE (slug));
...
CREATE TABLE IF NOT EXISTS public.categorias ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, CONSTRAINT categorias_nome_key UNIQUE (nome), CONSTRAINT categorias_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.categories ( id serial4 NOT NULL, "name" text NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT categories_name_key UNIQUE (name), CONSTRAINT categories_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.cliente_atributos ( id bigserial NOT NULL, idclientes int8 NOT NULL, idtipodocumento int4 NOT NULL, valor text NOT NULL, datacadastro timetz DEFAULT now() NOT NULL, CONSTRAINT cliente_atributos_pk PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.cliente_documento ( id serial4 NOT NULL, cliente_id int4 NOT NULL, tipo_documento_id int4 NOT NULL, nome_arquivo varchar(255) NOT NULL, arquivo_base64 text NOT NULL, data_upload timestamp DEFAULT now() NULL, CONSTRAINT cliente_documento_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.email_confirmation_tokens ( id serial4 NOT NULL, user_id int4 NOT NULL, token_hash text NOT NULL, expires_at timestamptz NOT NULL, used_at timestamptz NULL, created_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT email_confirmation_tokens_pkey PRIMARY KEY (id), CONSTRAINT email_confirmation_tokens_token_hash_key UNIQUE (token_hash));
...
CREATE TABLE IF NOT EXISTS public.escritorios ( id serial4 NOT NULL, nome text NOT NULL, empresa int4 NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, CONSTRAINT escritorios_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.etiquetas ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, exibe_pipeline bool DEFAULT true NOT NULL, ordem int4 NOT NULL, id_fluxo_trabalho int4 NOT NULL, idempresa int4 NULL, CONSTRAINT etiquetas_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.fluxo_trabalho ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, exibe_menu bool DEFAULT true NOT NULL, ordem int4 NULL, idempresa int4 NULL, CONSTRAINT fluxo_trabalho_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.integration_api_keys ( id bigserial NOT NULL, provider text NOT NULL, url_api text NULL, key_value text NOT NULL, environment text NOT NULL, active bool DEFAULT true NOT NULL, last_used timestamptz NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, "global" bool DEFAULT false NOT NULL, idempresa int8 NULL, CONSTRAINT integration_api_keys_id_pk PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.integrations ( id serial4 NOT NULL, instance_name varchar(150) NOT NULL, base_url text NOT NULL, "owner" varchar(20) NULL, "token" uuid NOT NULL, created_at timestamp DEFAULT now() NULL, updated_at timestamp DEFAULT now() NULL, CONSTRAINT integrations_pkey PRIMARY KEY (id), CONSTRAINT integrations_token_key UNIQUE (token));
...
CREATE TABLE IF NOT EXISTS public.labels ( id text DEFAULT gen_random_uuid() NOT NULL, "name" text NOT NULL, color text DEFAULT '#00a884'::text NOT NULL, company_id int8 NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT labels_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.notification_preferences ( user_id text NOT NULL, preferences jsonb NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT notification_preferences_pkey PRIMARY KEY (user_id));
...
CREATE TABLE IF NOT EXISTS public.notifications ( id bigserial NOT NULL, user_id text NOT NULL, category text NOT NULL, "type" text DEFAULT 'info'::text NOT NULL, title text NOT NULL, message text NOT NULL, metadata jsonb NULL, action_url text NULL, "read" bool DEFAULT false NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, read_at timestamptz NULL, CONSTRAINT notifications_pkey PRIMARY KEY (id), CONSTRAINT notifications_type_check CHECK ((type = ANY (ARRAY['info'::text, 'success'::text, 'warning'::text, 'error'::text]))));
...
CREATE TABLE IF NOT EXISTS public.oportunidade_documentos ( id serial4 NOT NULL, oportunidade_id int4 NOT NULL, template_id int4 NULL, title text NOT NULL, "content" text NOT NULL, variables jsonb DEFAULT '{}'::jsonb NOT NULL, created_at timestamp DEFAULT now() NOT NULL, CONSTRAINT oportunidade_documentos_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.oportunidade_envolvidos ( id serial4 NOT NULL, oportunidade_id int4 NOT NULL, nome text NULL, documento text NULL, telefone text NULL, endereco text NULL, relacao text NULL, polo varchar NULL, CONSTRAINT oportunidade_envolvidos_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.oportunidade_sequence ( empresa_id int4 NOT NULL, atual int4 NOT NULL, CONSTRAINT oportunidade_sequence_pkey PRIMARY KEY (empresa_id));
...
CREATE TABLE IF NOT EXISTS public.ops_uaz_sse_tokens ( credential_id text NOT NULL, sse_token text NOT NULL, sse_base_url text NULL, CONSTRAINT ops_uaz_sse_tokens_pkey PRIMARY KEY (credential_id));
...
CREATE TABLE IF NOT EXISTS public.password_reset_tokens ( id serial4 NOT NULL, user_id int4 NOT NULL, token_hash text NOT NULL, expires_at timestamptz NOT NULL, used_at timestamptz NULL, created_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT password_reset_tokens_pkey PRIMARY KEY (id), CONSTRAINT password_reset_tokens_token_hash_key UNIQUE (token_hash));
...
CREATE TABLE IF NOT EXISTS public.perfil_modulos ( perfil_id int4 NOT NULL, modulo text NOT NULL, CONSTRAINT perfil_modulos_pkey PRIMARY KEY (perfil_id, modulo));
...
CREATE TABLE IF NOT EXISTS public.perfis ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, ver_todas_conversas bool DEFAULT true NOT NULL, CONSTRAINT perfis_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.processo_consultas_api ( id serial4 NOT NULL, processo_id int4 NOT NULL, consultado_em timestamp DEFAULT now() NOT NULL, sucesso bool DEFAULT true NOT NULL, detalhes text NULL, CONSTRAINT processo_consultas_api_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.quick_answers ( id serial4 NOT NULL, empresa_id int4 NOT NULL, shortcut text NOT NULL, message text NOT NULL, media_url text NULL, media_type text NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT quick_answers_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.schema_migrations ( id serial4 NOT NULL, "name" text NOT NULL, applied_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT schema_migrations_name_key UNIQUE (name), CONSTRAINT schema_migrations_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.sistema_cnj ( id serial4 NOT NULL, nome varchar NOT NULL, CONSTRAINT sistema_cnj_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.situacao_cliente ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, CONSTRAINT situacao_cliente_nome_key UNIQUE (nome), CONSTRAINT situacao_cliente_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.situacao_processo ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, CONSTRAINT situacao_processo_nome_key UNIQUE (nome), CONSTRAINT situacao_processo_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.situacao_proposta ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, CONSTRAINT situacao_proposta_nome_key UNIQUE (nome), CONSTRAINT situacao_proposta_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.support_request_attachments ( id serial4 NOT NULL, message_id int4 NOT NULL, filename text NOT NULL, content_type text NULL, file_size int4 NULL, "data" bytea NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT support_request_attachments_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.support_request_messages ( id serial4 NOT NULL, support_request_id int4 NOT NULL, sender text NOT NULL, message text NOT NULL, created_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT support_request_messages_pkey PRIMARY KEY (id), CONSTRAINT support_request_messages_sender_check CHECK ((sender = ANY (ARRAY['requester'::text, 'support'::text]))));
...
CREATE TABLE IF NOT EXISTS public.tags ( id serial4 NOT NULL, "key" text NOT NULL, "label" text NOT NULL, example text NULL, group_name text NULL, CONSTRAINT tags_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.tarefas_responsaveis ( id_tarefa int4 NOT NULL, id_usuario int4 NOT NULL, CONSTRAINT tarefas_responsaveis_pkey PRIMARY KEY (id_tarefa, id_usuario));
...
CREATE TABLE IF NOT EXISTS public.templates ( id serial4 NOT NULL, title text NOT NULL, "content" text NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, idusuario int4 NULL, CONSTRAINT templates_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.tipo_documento ( id serial4 NOT NULL, nome varchar(255) NOT NULL, ativo bool DEFAULT true NULL, datacriacao timestamp DEFAULT now() NULL, idempresa int4 NULL, CONSTRAINT tipo_documento_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.tipo_envolvimento ( id serial4 NOT NULL, descricao text NOT NULL, CONSTRAINT tipo_envolvimento_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.tipo_evento ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, agenda bool DEFAULT true NOT NULL, tarefa bool DEFAULT true NOT NULL, idempresa int4 NULL, CONSTRAINT tipo_evento_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.tipo_processo ( id serial4 NOT NULL, nome text NOT NULL, ativo bool DEFAULT true NOT NULL, datacriacao timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, idareaatuacao int4 NULL, CONSTRAINT tipo_processo_unique UNIQUE (id));
...
CREATE TABLE IF NOT EXISTS public.token_jusbr ( id int4 GENERATED ALWAYS AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL, access_token text NULL, expires_in int4 NULL, refresh_expires_in int4 NULL, refresh_token text NULL, token_type varchar NULL, id_token text NOT NULL, "not-before-policy" int4 NULL, session_state varchar NULL, "scope" varchar NULL, expired bool NOT NULL, datatimerenewal timestamp NOT NULL, timestamp_expirate timestamp NULL, idusuario int4 NULL, CONSTRAINT token_jusbr_pk PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.trigger_assuntos_processo ( id int4 GENERATED ALWAYS AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL, numero_cnj varchar NULL, codigo_assunto varchar NULL, assunto varchar NULL, data_cadastro timestamp DEFAULT now() NOT NULL, CONSTRAINT assuntos_processo_pk PRIMARY KEY (id), CONSTRAINT trigger_assuntos_processo_unique UNIQUE (numero_cnj, codigo_assunto));
...
CREATE TABLE IF NOT EXISTS public.trigger_envolvidos_processo ( numero_cnj varchar NOT NULL, nome varchar NULL, polo varchar NULL, tipo_pessoa varchar NULL, documento_principal varchar NULL, tipo_documento_principal varchar NULL, sigilosa bool NULL, data_cadastro timestamp DEFAULT now() NOT NULL, tipo_parte varchar NULL, grau varchar NULL, CONSTRAINT trigger_envolvidos_processo_unique UNIQUE (numero_cnj, documento_principal));
...
CREATE TABLE IF NOT EXISTS public.uazapi_message_media ( message_id text NOT NULL, base64_data text NULL, mimetype text NULL, file_url text NULL, transcription text NULL, created_at timestamptz DEFAULT now() NULL, CONSTRAINT uazapi_message_media_pkey PRIMARY KEY (message_id));
...
CREATE TABLE IF NOT EXISTS public.uazapi_webhook_events ( event_id text NOT NULL, received_at timestamptz DEFAULT now() NULL, CONSTRAINT uazapi_webhook_events_pkey PRIMARY KEY (event_id));
...
CREATE TABLE IF NOT EXISTS public.user_profile_audit_logs ( id bigserial NOT NULL, user_id int4 NOT NULL, "action" text NOT NULL, description text NOT NULL, performed_by int4 NULL, performed_by_name text NULL, created_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT user_profile_audit_logs_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.usuarios ( id serial4 NOT NULL, nome_completo text NOT NULL, cpf varchar NULL, email varchar NOT NULL, perfil int4 NOT NULL, empresa int4 NOT NULL, setor int4 NULL, oab varchar NULL, status bool DEFAULT true NOT NULL, senha varchar NULL, telefone varchar NULL, ultimo_login timestamp NULL, observacoes text NULL, datacriacao timestamp DEFAULT now() NOT NULL, must_change_password bool NULL, email_confirmed_at timestamp NULL, welcome_email_pending bool DEFAULT false NOT NULL, CONSTRAINT usuarios_email_key UNIQUE (email), CONSTRAINT usuarios_pkey PRIMARY KEY (id), CONSTRAINT usuarios_unique UNIQUE (cpf));
...
CREATE TABLE IF NOT EXISTS public.webhook_logs ( id bigserial NOT NULL, instance_token varchar(255) NOT NULL, event_type varchar(50) NULL, payload jsonb NULL, received_at timestamp DEFAULT CURRENT_TIMESTAMP NULL, CONSTRAINT webhook_logs_pkey PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS public.agenda ( id serial4 NOT NULL, titulo text NOT NULL, tipo int4 NULL, descricao text NULL, "data" date NOT NULL, hora_inicio time NULL, hora_fim time NULL, cliente int4 NULL, tipo_local varchar(10) NULL, "local" text NULL, lembrete bool DEFAULT false NULL, status int4 NULL, datacadastro timestamp DEFAULT now() NOT NULL, idempresa int4 NULL, idusuario int4 NULL, dataatualizacao timestamp NULL, id_tarefa int4 NULL, CONSTRAINT agenda_pkey PRIMARY KEY (id), CONSTRAINT agenda_tipo_local_check CHECK (((tipo_local)::text = ANY (ARRAY[('INTERNO'::character varying)::text, ('EXTERNO'::character varying)::text]))), CONSTRAINT agenda_tarefas_fk FOREIGN KEY (id_tarefa) REFERENCES public.tarefas(id));
...
CREATE TABLE IF NOT EXISTS public.integration_webhooks ( id bigserial NOT NULL, "name" text NOT NULL, target_url text NOT NULL, events _text DEFAULT '{}'::text[] NOT NULL, secret text NOT NULL, active bool DEFAULT true NOT NULL, last_delivery timestamptz NULL, idempresa int8 NULL, created_at timestamptz DEFAULT now() NOT NULL, updated_at timestamptz DEFAULT now() NOT NULL, CONSTRAINT integration_webhooks_pkey PRIMARY KEY (id), CONSTRAINT integration_webhooks_idempresa_fkey FOREIGN KEY (idempresa) REFERENCES public.empresas(id) ON DELETE SET NULL);
